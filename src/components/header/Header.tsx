  ...
  return (
    <>
      <header className="pt-4 pb-2 px-4 md:px-5 lg:px-20 md:pb-5 md:pt-0 bg-header flex justify-between">
        ...
        <div className="hidden md:block text-xs relative self-center sm:mt-5 xl:ml-16">
          <input
        ...
        <div className="w-16 pb-6 pr-1 md:pr-0 self-end md:w-auto md:self-center md:pb-0 sm:mt-5">
          <svg
          ...
          <svg
            className="hidden md:inline-block md:ml-4 xl:ml-5"
            width="39.000000"
            height="38.000000"
            viewBox="0 0 39 38"
            fill="none"
          ...
          <svg
            className="inline-block ml-1.5 md:hidden"
            width="25.000000"
            height="25.000000"
            viewBox="0 0 25 25"
            fill="none"
          ...
          <svg
            className="hidden md:inline-block md:ml-4"
            width="34.000000"
            height="34.000000"
            viewBox="0 0 34 34"
            fill="none"
