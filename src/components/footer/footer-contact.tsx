...
const FooterContact = (props: Props) => {
  return (
    <address className="flex flex-col place-items-center md:place-items-start">
      <p className="mb-2 text-lg md:text-base xl:text-lg not-italic font-normal leading-[normal]">
        CONTACT US
      </p>
      <ul className="flex flex-col gap-2 xl:gap-[14px] pl-14 md:pl-0 md:text-xs xl:text-base not-italic">
        <li className="flex items-center gap-2">
          <IconPhone />
          <a
            className="duration-200 ease-linear lg:hover:text-[#C3C3C3]"
            href="tel:+380970987887"
          >
            +380970987887
          </a>
        </li>
        <li className="flex items-center gap-2">
          ...
          <a
            className="duration-200 ease-linear lg:hover:text-[#C3C3C3]"
            href="mailto:munkopop@gmail.com"
          >
            munkopop@gmail.com
          </a>
        </li>
        <li className="flex items-center gap-2">
          <IconMap />
          <a
            className="duration-200 ease-linear lg:hover:text-[#C3C3C3] md:w-[146px] xl:w-[220px]"
            target="_blank"
            rel="noreferrer"
