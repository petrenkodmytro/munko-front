...
const Catalog = () => {
  return (
    <section className='mb-8 md:mb-12 lg:mb-14'>
      ...
      <div className='ml-4 md:ml-0 mb-5 md:mb-9 md:px-20 flex md:flex-wrap justify-between lg:justify-evenly xl:justify-between md:gap-[76px] lg:gap-5 lg:px-[164px]'>
        <Card />
        <Card />
        <Card />
        <Card />
