...
const ProductCard = (props: Props) => {
  //fetch
  return (
    <div className='md:px-5 md:pb-[72px]'>
      <p className='hidden md:block py-[25px] text-xs font-medium'>Catalog/Disney/Cartoons</p>
      <CardImage />
      <div className="px-[16px] py-[30px] md:px-0 md:pb-10">
        ...
        <div className="flex justify-between">
          <button
            type="button"
            className="uppercase px-[25px] py-[14px] rounded-[5px] border-2 border-current text-white bg-[#31304D] text-base not-italic font-bold  lg:hover:text-[#31304D] lg:hover:bg-white duration-200 ease-linear md:px-[90px]"
          >
            add to cart
          </button>
          <button
            type="button"
            className="uppercase px-[25px] py-[14px] rounded-[5px] border-2 border-current text-[#31304D] bg-white text-base not-italic font-bold  lg:hover:text-white lg:hover:bg-[#31304D] duration-200 ease-linear md:px-[90px]"
          >
            Fast order
          </button>
        </div>
      ...
      <div className="flex flex-col gap-5 md:gap-[25px]  px-[16px] py-5 mb-5 rounded-[5px] bg-[#F5F5F5] md:pl-8 md:pr-[84px] md:py-[22px]">
